	...
	<script language="javascript">		
		...
		*/
		function findOutSubmit()
		{
			...
			document.frm.action="<c:out value='${webapp}'/>/listOnlineMain.action";
...
<body onload="displayTreeInst(true)">
    <form name="frm" id="frm" action="<c:out value='${webapp}'/>/listOnlineMain.action" method="post" target="onlineSearchResultFrame">
			...
			<tr>
				<td align="left">
					<div id="tbl_current_status">
						...
						<span class="current_status_submenu">在线用户查询</span>
					</div>
				</td>
			</tr>
	    	<tr>
						...
						<table>
							<tr>
								...
								用户登陆名
								 ...
								 <td align="left" >
								 <span><input class="tbl_query_text"  name="user.userId" id="user.userId" type="text" /></span>
								 </td>
								 <td align="left" >
								 用户IP
								 </td>
								 <td align="left" >
								 <span><input class="tbl_query_text"  name="user.addr" id="user.addr" type="text" /></span>
								 </td>
