...
<!-- 首页TAB JS -->
<script language="javascript" src="<c:out value="${webapp}"/>/js/welcome.js"></script>
...
<!-- tab控件JS及CSS 开始 -->
<script language="javascript" src="<c:out value="${webapp}"/>/js/ScrollTab/js/ScrollTab.js"></script>
