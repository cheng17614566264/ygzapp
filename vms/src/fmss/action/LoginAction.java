	...
	public String execute() throws Exception {
		...
		try{
			...
			if (usdo == null) {
				...
				System.out.println("1."+ServletHelper.getRemoteAddr(request));
				
				usdo.setIp(ServletHelper.getRemoteAddr(request));
				
				/*usdo.setIp("0:0:0:0:0:0:0:1");*/
				
				System.out.println("2."+usdo.getIp());
				String newLoginId = loginService.getNewLoginId(usdo.getUserId(),usdo.getIp());
				
				System.out.println("3."+usdo.getUserId());
	 			synchronized(this){
