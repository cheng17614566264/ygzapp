...
public class SubSystemAdminDeleteChangeType extends AbstractChangeType {
...
//		SubSystemChangeDO o = (SubSystemChangeDO) entity;
//		if(o == null)
//			return "";
...
//审核通过
	public String getApproveURL() {
		...
		if(o == null)
			return "";
		String action = "approveSubSystemAdminDelChanges.action?roleId=" + o.getUserId()+"&id="+o.getId()+"&systemId="+o.getSystemId();
		return action;
	}
//审核不通过
	public String getRejectURL() {
		...
		if(o == null)
			return "";
		String action = "rejectSubSystemAdminDelChanges.action?roleId=" + o.getUserId()+"&id="+o.getId()+"&systemId="+o.getSystemId();
		return action;
	}
//状态参数
...
//撤销cancelSubSystemChanges
	public String getCancelURL() {
		...
		int count = dao.findForInt(sql, new Object[] {
				...
				login.getUserId() });
		if (count > 0) {
			cancelURL = "cancelSubSystemAdminDelChanges.action?roleId=" + o.getUserId()+"&id="+o.getId()+"&systemId="+o.getSystemId();
		}
		return cancelURL;
	}
//查看按钮
