...
public class UBaseInstDeleteChangeType extends AbstractChangeType {
...
//详细信息（变更审核）
	public String getDetailURL() {
		...
		if(o == null)
			return "";
		String action = "showOwnUBaseInstChanges.action?roleId=" + o.getInstId();
...
//		return (String) AuditBase.TYPE_DESC_MAP.get(AuditBase.CHANGE_TYPE_INST_DELETE);
		return "机构删除";
	}
...
//审核通过
	public String getApproveURL() {
		...
		if(o == null)
			return "";
		String action = "approveInstDeleteChanges.action?roleId=" + o.getInstId();
		return action;
	}
//审核不通过
