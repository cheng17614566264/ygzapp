...
<body>
	<div class="showBoxDiv">
		...
		<form id="doEditTaxDiskMonitorForm"
			action="<c:out value='${webapp}'/>/updateTaxDiskMonitor.action"
			method="post">
			<div id="editpanel">
	 ...
	 -->
							<tr>
								...
								<td width="35%"><input type="text" class="tbl_query_text"
									...
									disabled maxlength="12" /> <input type="hidden"
									name="taxDiskMonitorInfo.taxDiskNo" id="taxDiskNo"
									value="<s:property value='taxDiskMonitorInfo.taxDiskNo'/>" />
								</td>
							</tr>
							<tr>
								...
								<td><input type="hidden"
									name="taxDiskMonitorInfo.fapiaoType"
									value="<s:property value='taxDiskMonitorInfo.fapiaoType'/>" />
									<select id="fapiaoType" name="" disabled><option
											value=""
							...
							<tr>
								...
								<td><select id="nBillFlgS"
									name="taxDiskMonitorInfo.nBillFlgS">
										<option value="1"
											<s:if test='taxDiskMonitorInfo.nBillFlgS==1'>selected</s:if>>1:在盘内</option>
										<option value="2"
											<s:if test='taxDiskMonitorInfo.nBillFlgS==2'>selected</s:if>>2:不在盘内</option>
								</select></td>
								<!--		<td>-->
