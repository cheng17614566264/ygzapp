				...
				<td class="centercondition">
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
							...
							class="current_status_submenu">票据预开</span>
					</div>
										...
										<table class="lessGrid" cellspacing="0" rules="all" border="0"
											...
											<s:if
												...
												<s:iterator value="goodsLists" id="iList" status="stuts">
													<tr name="iteratorBillItem" align="center"
														class="<s:if test='#stuts.index%2 == 0'>lessGrid rowA</s:if><s:else>lessGrid rowB</s:else>">
														<td style='width: 15%;'><select id="goodsNo"
															name="goodsFullName" class="tbl_query_text5"
															onchange='change(this,this.value);'>
																<option value='<s:property value="goodsId"/>'><s:property
																		value="goodsFullName" /></option>
														</select> <span class='spanstar'>*</span></td>
														<td style='width: 13%;'><s:hidden name="goodsName" />
															<input type='text' name='specandmodel'
															class='tbl_query_text3'
														...
														<td style='width: 7%;'><input type='text'
															name='goodsUnit' class='tbl_query_text6'
															value="<s:property value="#iList.goodsUnit"/>"
															style='text-align: left;' readonly="readonly" /></td>
														<td style='width: 11%'><input type='text'
															name='sumAmt' class='tbl_query_text3'
															value="<s:property value="#iList.amt"/>"
															style='text-align: right;'
															onkeyup='keySumAmt(this,this.value);' /></td>
														<td style='width: 13%;'><input type='text'
															name='income' class='tbl_query_text3'
															value="<s:property value="#iList.income"/>"
															style='text-align: right;'
															onkeyup='keyIncome(this,this.value);' /></td>
														<td style='width: 5%;'><input type='text'
															name='goodsNum' class='tbl_query_text4'
						...
						<s:iterator value="transBusIdList" status="status" id="tbi">
							<tr>
								<td style="width: 80%; text-align: right;"><s:textfield
										name="transBusId" value="%{transBusId}"
										cssClass="tbl_query_text2" /></td>
