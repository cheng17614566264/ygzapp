...
function updatestar(id) {
	...
	submitForm('billLostList.action');
}
...
function viewImgFromInvoiceJF(){
	...
	if(count>1){
		...
		alert("请选择记录")
		 ...
		 OpenModalWindowSubmit('viewImgFromLostRecycle.action?fileName='+val,1000,650,true);
	}
}
...
<body>
	<form name="Form1" method="post" action="billLostList.action"
		id="Form1">
				...
				<td class="centercondition"><s:component
					...
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png"> <span
							...
							class="current_status_submenu">空白发票遗失确认</span>
					</div> <!-- 查询框 -->
						...
						<table id="tbl_query" cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								...
								<td colspan="2" style="padding-left: 10.5%"><input
									type="button" onclick="submitForm('billLostList.action')"
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr align="left">
							<td style="text-align: left"><a href="#"
								onclick="submitForm('createExecllostRecycle.action?massage=lost');"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td><input type="checkbox"
										...
										value="<s:property value='id'/>" /> <input name="selects"
										value='<s:property value='billId'/>-<s:property value='billStartNo'/>-<s:property value='billEndNo'/>'
										hidden /></td>
									...
									<td align="center"><s:if test='state=="0"'>
											<a href="#"
												onclick="updatestar('<s:property value="id"/>-<s:property value="disId"/>-<s:property value='count'/>-ys')">
												<img
