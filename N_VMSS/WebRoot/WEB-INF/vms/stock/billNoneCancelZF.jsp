...
<script type="text/javascript">
	...
	*/
	function updatestar(id) {
		...
		submitForm('SelectNoneAction.action');
	}
	
	function zfcannot(id){
		$.ajax({
			type: 'POST', 
			url: 'zfcannot.action', 
			data: {Id:id}, 
						...
						<table id="tbl_query" cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								...
								<td colspan="2" style="padding-left: 10.5%"><input
									type="button" onclick="submitForm('SelectNoneAction.action')"
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							<td align="left"><a href="#"
								onclick="submitForm('createExecllostRecycle.action?massage=ZF');"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td align="center"><s:if test='state=="0"'>
											<a href="#"
												onclick="updatestar('<s:property value="id"/>-<s:property value="disId"/>-<s:property value='count'/>-zf')">
												<img
											...
											<a href="#" name="BtnView" id="BtnView"
												onclick="zfcannot('<s:property value="id"/>')"> <img
												src="<c:out value="${bopTheme}"/>/themes/images/icons/delete.png"
												title="撤销" />
											</a>
										</s:if>
										<s:else>
