...
function cmdDistribute(){
	...
	cmdDistribute.href="initDistrubute.action?inventoryId="+inventoryId[k].value;
}
</script>
<body>
	<form name="Form1" method="post" action="billInventoryList.action"
		...
		<table id="tbl_main" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td class="centercondition"><s:component
					...
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png"> <span
							...
							class="current_status_submenu">发票入库</span>
					</div> <!-- 查询框 -->
						...
						<table id="tbl_query" cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								<td colspan="2" style="padding-left: 10.5%"><input
									type="button" onclick="submitForm('billInventoryList.action')"
				...
				<a href="#" name="cmdDistribute" id="cmdDistribute" onClick="cmdDistribute()">
					<img src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1001.png" />
									分发
				</a>
				 --> <a href="#"
						...
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td>
										<%-- 
					    	<s:if test='#iList.syCount=="0"'>
					    		<input type="checkbox" style="width:13px;height:13px;"  name="inventoryId" value="<s:property value='inventoryId'/>" disabled="disabled"/>
					    	</s:if><s:else>
					    		<input type="checkbox" style="width:13px;height:13px;"  name="inventoryId" value="<s:property value='inventoryId'/>"/>
					    	</s:else>
