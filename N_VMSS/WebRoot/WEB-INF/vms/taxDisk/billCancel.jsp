						...
						<table id="tbl_query" cellpadding="0" cellspacing="0" width="80%"
							...
							<tr>
								...
								<td><input class="tbl_query_time" id="billBeginDate"
									...
									id="billEndDate" type="text" name="billCancelInfo.billEndDate"
							...
							<tr>
								...
								<td><s:select list="#{'1':'全部','2':'人工审核','3':'人工开票'}"
										name="billCancelInfo.isHandiwork" label="abc" listKey="key"
										listValue="value" /></td>
								<td>
									<!-- 							发票号码 -->
								</td>
								<td>
									...
									<!-- 								maxlength="10" --> <!-- 								value="<s:property value='billCancelInfo.billNo'/>" /> -->
								</td>
								<td></td>
