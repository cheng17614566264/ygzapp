						...
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td align="left"><s:property value="instCode" /></td>
									...
									<!-- 未开票金额 -->
									<td align="right"><s:property
											value='@com.cjit.common.util.NumberUtils@format(balance,"", 2)' />
									</td>
									<!-- 累计未开票金额 -->
									<td align="right"><s:property
											value='@com.cjit.common.util.NumberUtils@format(wkze,"", 2)' />
									</td>
									<!-- 交易状态 -->

									<td align="center"><s:property
											value="@com.cjit.vms.trans.util.DataUtil@getDataStatusCH(dataStatus,
									'TRANS')" />
									</td>
									<!-- 承保日期 -->
