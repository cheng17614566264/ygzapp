...
<body>
	<form id="main"
		action="<c:out value='${webapp}'/>/listTransConfig.action"
		method="post">
				...
				<td class="centercondition">
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
							...
							class="current_status_submenu">交易配置</span>
					</div>
					<div class="widthauto1">
						<table id="tbl_query" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td align="left">交易科目:</td>
								<td><input class="tbl_query_text"
									id="transConfig.transName" type="text"
									name="transConfig.transName"
									value="<s:property value='transConfig.transName'/>" /></td>
								<td align="left">交易认定名称:</td>
								<td><input class="tbl_query_text"
									name="transConfig.verificationName"
									value="<s:property value='transConfig.verificationName'/>" />
								</td>
							</tr>
							<tr>
								<td>纳税人类型</td>
								<td><s:select name="transConfig.taxType" list="taxTypeList"
