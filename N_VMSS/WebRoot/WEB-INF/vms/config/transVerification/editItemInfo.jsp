			...
			<div id="editsubpanel" class="editsubpanel">
				<div style="overflow: auto; width: 100%;">
					...
					<table id="contenttable" class="lessGrid" cellspacing="0"
						...
						<tr class="header">
							<th colspan="4"><s:if test="!createFlag">修改认定类型</s:if> <s:else>新增认定类型</s:else>
								<s:hidden name="itemInfoForm.parentCode"></s:hidden> <s:hidden
									name="itemInfoForm.path"></s:hidden> <s:hidden
									name="createFlag"></s:hidden> <s:hidden
									name="itemInfoForm.taxNo"></s:hidden></th>
						</tr>
						<tr>
							<td align="right" class="listbar" style="width: 120px">类型编号:</td>
							<td><s:if test="createFlag">
									<s:textfield id="itemCode" name="itemInfoForm.itemCode"
										cssClass="tbl_query_text2" maxlength="50"></s:textfield>
								</s:if> <s:else>
									<s:textfield id="itemCode" name="itemInfoForm.itemCode"
						...
						<tr>
							...
							<td><s:textfield name="itemInfoForm.itemName"
									cssClass="tbl_query_text2" maxlength="50"></s:textfield> <span
						...
						<tr>
							...
							<td><s:textarea name="itemInfoForm.remark"></s:textarea></td>
						</tr>
