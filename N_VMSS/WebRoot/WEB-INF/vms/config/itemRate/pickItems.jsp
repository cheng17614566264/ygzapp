...
<body>
	<form id="main2" action="saveItemRate.action" method="post"
				...
				<td class="centercondition">
					<div class="widthauto1">
						<table id="tbl_query" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td>科目编号</td>
								<td><s:textfield name="verificationInfo.itemCode"
										cssClass="tbl_query_text"></s:textfield></td>
								<td>科目名称</td>
								<td><s:textfield name="verificationInfo.itemName"
										cssClass="tbl_query_text"></s:textfield></td>
								<td><s:hidden name="itemCodeIsEmpty"></s:hidden> <input
									type="button" value="查询" id="btnSearch"
									class="tbl_query_button"
									onMouseMove="this.className='tbl_query_button_on'"
									onMouseOut="this.className='tbl_query_button'"
									name="cmdDistribute" /></td>
							</tr>
						</table>
					</div>
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							...
							<td style="width: 200px"><s:select
									name="verificationInfo.taxRate" list="taxRateSelList"
									listKey='value' listValue='text' cssClass="tbl_query_text1"></s:select>
