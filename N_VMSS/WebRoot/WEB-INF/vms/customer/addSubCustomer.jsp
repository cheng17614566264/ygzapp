...
<body>
	<form name="formCustomer" id="formCustomer"
		action="saveSubCustomer.action" method="post">
		<div class="windowtitle"
			style="background: #004C7E; height: 45px; line-height: 45px; text-align: center; color: #FFF; font-weight: bold; font-size: 14px;">新增子公司</div>
		<div class="windowtitle"
			style="background: #004C7E; height: 30px; line-height: 30px; text-align: left; color: #FFF; font-size: 12px; margin-top: 10px;">子公司基本信息</div>
		<table id="contenttable" class="lessGrid" cellspacing="0" width="100%"
			...
			<tr>
				...
				<td><input size="30" id="customerID" class="tbl_query_text"
					name="subCustomer.subCustomerId" type="text" maxlength="20"
			...
			<tr>
				...
				<td width="35%"><input size="30" id="customerCName"
					...
					type="text" maxlength="20" onblur="funCheckTname()" /> &nbsp; <span
			...
			<tr>
				...
				<td width="35%"><input size="30" id="customerTaxno"
					class="tbl_query_text" name="subCustomer.subCustomerTaxno"
					type="text" onblur="funCheckgTaxNo()" maxlength="18" /> &nbsp; <span
					style="color: red;" class="checkFapiaoType hiddenStar">*</span> <label
					id="taxNo" style="display: none; color: #FF0000; font-size: 14">子公司识别号格式有误</label>
					<label id="taxNo1"
					style="display: none; color: #FF0000; font-size: 14">请输入</label></td>
				<td width="15%" align="right" class="listbar">国籍:</td>
				<td width="35%"><select id="customerNationality"
					name=subCustomer.subCustomerNationality>
			...
			<tr>
				...
				<td width="35%"><input size="40" id="customerAddress"
					...
					type="text" maxlength="100" onblur="funCheckAddress()" /> &nbsp; <span
					style="color: red;" class="checkFapiaoType hiddenStar">*</span> <label
				...
				<td width="35%"><input size="30" id="customerPhone"
					...
					type="text" maxlength="20" onblur="funCheckphone()" /> &nbsp; <span
					style="color: red;" class="checkFapiaoType hiddenStar">*</span> <label
			...
			<tr>
				...
				<td width="35%"><input size="30" id="customerEmail"
					...
					type="text" onblur="funCheckemail()" /> &nbsp; <span
				...
				<td width="35%"><input size="30" id="customerCBank"
					...
					type="text" onblur="funCheckCustomerCBank()" /> &nbsp; <span
					style="color: red;" class="checkFapiaoType hiddenStar">*</span> <label
			...
			<tr>
				...
				<td width="35%"><input size="30" id="customerAccount"
					...
					type="text" maxlength="20" onblur="funCheckAccount()" /> &nbsp; <span
					style="color: red;" class="checkFapiaoType hiddenStar">*</span> <label
			...
			<tr>
				...
				<td width="35%"><select id="fapiaoType"
					name="subCustomer.fapiaoType" onchange="checkFapiaoType()">
