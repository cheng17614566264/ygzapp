				...
				<td class="centercondition">
					...
					<div class="widthauto1">
						<table id="tbl_query" cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								<td>机构</td>
								<td><input type="hidden" id="inst_id" name="instCode"
									value='<s:property value="instCode"/>'> <input
						...
						<td>
							<select id="fapiaoType" name="fapiaoType" ><option value="" <s:if test='fapiaoType==""'>selected</s:if><s:else></s:else>>所有</option>
								...
								<td colspan="4"><input type="button"
									...
									onclick="submitForm('inputInvoiceInfoList.action');"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td><a href="javascript:void(0);"
										onClick="openViewData('inputInvoiceInfoViewData.action?billId=<s:property value="#iList.billId" />');">
											<img
											src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1014.png"
											title="查看数据" style="border-width: 0px;" />
									</a></td>
									<td><a href="javascript:void(0);"
										onClick="openViewImg('inputInvoiceInfoViewImg.action?billId=<s:property value="#iList.billId" />');">
											<img
