				...
				<td class="centercondition">
					...
					<div id="lessGridList4" style="overflow: auto; width: 100%;">
						<div class="Box">
							<div class="tableBox">
								<div class="tablehead">
									<table class="lessGrid,head" cellspacing="0" rules="all"
										...
										<tr class="lessGrid head" id="head">
											...
											<th style="text-align: center" id="h3">发票代码</th>
											<th style="text-align: center" id="h4">发票号码</th>
											<th style="text-align: center" id="h5">开票日期</th>
											<th style="text-align: center" id="h6">金额</th>
											<th style="text-align: center" id="h7">税率</th>
											<th style="text-align: center" id="h8">税额</th>
											<th style="text-align: center" id="h9">价税合计金额</th>
											<th style="text-align: center" id="h10">发票类型</th>
											<th style="text-align: center" id="h11">供应商名称</th>
											<th style="text-align: center" id="h12">供应商纳税人识别号</th>
											<th style="text-align: center" id="h13">认证结果</th>
											<th style="text-align: center" id="h14">认证时间</th>
											<th style="text-align: center" id="h15">转出状态</th>
											<th style="text-align: center" id="h16">转出原因</th>
											<th style="text-align: center" id="h17">转出税额</th>
											<th style="text-align: center" id="h18">进项转出率</th>
										</tr>
									</table>
								</div>
								<div class="tablebody">
									<table class="lessGrid,body" cellspacing="0" rules="all"
										border="0" cellpadding="0"
										style="border-collapse: collapse; width: 100%;">
										<s:iterator value="paginationList.recordList" id="iList"
											...
											<tr align="center"
												...
												<td><s:property value='#iList.shareInst' /></td>
												<td align="center"><s:property value='#iList.billId' /></td>
												<td><s:property value='#iList.billCode' /></td>
												...
												<td><input type="hidden" name="billType"
												...
												<td><s:property value='#iList.rollOutval' /></td>
						...
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<%-- <s:iterator value="paginationList.recordList" id="iList"
									...
									<tr align="center"
										class="<s:if test='#stuts.index%2 == 0'>lessGrid rowA</s:if><s:else>lessGrid rowB</s:else>">
										<td>
											<input type="checkbox" style="width:13px;height:13px;" name="billId" value="<s:property value='#iList.billId'/>-<s:property value='#iList.billCode' />" />
										</td>
										<td><s:property value='#iList.shareInst' /></td>
										<td align="center"><s:property value='#iList.billId' /></td>
										<td><s:property value='#iList.billCode' /></td>
										...
										<td><s:property
												value='@com.cjit.common.util.NumberUtils@format(sumAmt," ", 2)' /></td>
										<td>
											<input type="hidden" name="billType" value="<s:property value='billType' />" />
											<s:property value='@com.cjit.vms.trans.util.DataUtil@getFapiaoTypeCH(billType)' />
										<td>
											<div class=ellipsis_div style="width: 120px;"
												title="<s:property value='#iList.name'/>">
												<s:property value='#iList.name' />
										...
										<td><s:property value='#iList.taxNo' /></td>
										<td>
											<s:property value='@com.cjit.vms.trans.util.JSPUtil@getValue(@com.cjit.vms.input.model.InputInfoUtil@billStatuMap,billStatu)' />
										</td>
										<td><s:property value='#iList.dealNo' /></td>
										<td>
											<s:property value='@com.cjit.vms.trans.util.JSPUtil@getValue(@com.cjit.vms.input.model.InputInfoUtil@rollOutStatusMap,rollOutStatus)' />
										</td>
										<td>
											<s:property value='@com.cjit.vms.trans.util.JSPUtil@getValue(@com.cjit.vms.input.model.InputInfoUtil@remarkMap,remark)' />
										</td>
										<td><s:property value='@com.cjit.common.util.NumberUtils@format(rollOutAmt," ", 2)' /></td>
										<td><s:property value='#iList.rollOutval' /></td>
										<td><a href="javascript:;" class="cmdViewBt"
											rel="<s:property value="billId"/>-<s:property value="billCode"/>">
												<img
