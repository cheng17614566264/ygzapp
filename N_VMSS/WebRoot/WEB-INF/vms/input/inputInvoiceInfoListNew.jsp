...
<body>
	<form id="main"
		action="<c:out value='${webapp}'/>/inputInvoiceInfoList.action"
		method="post">
				...
				<td class="centercondition">
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
							...
							class="current_status_submenu">抵扣预警</span>
					</div>
					<div class="widthauto1">
						<table id="tbl_query" cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								<td>开票日期</td>
								<td><input id="billDate" name="billDate" type="text"
									value="<s:property value='billDate' />" class="tbl_query_time"
									onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
									&nbsp;&nbsp;&nbsp;</td>
								<td>供应商纳税人识别号</td>
								<td><input id="vendorTaxno" class="tbl_query_text"
									name="vendorTaxno" type="text"
									value="<s:property value='vendorTaxno' />" style="width: 150px" />
								</td>
								<td>发票状态</td>
								<td><select id="datastatus" name="datastatus">
										<option value="" <s:if test='datastatus==""'>selected</s:if>
							...
							<option value="">请分配机构权限</option>
								...
								<td><s:select id="industryType" name="industryType"
										list="industryTypeList" headerKey="" headerValue="全部"
										listKey='code' listValue='name' cssClass="tbl_query_text" /></td>
								<td>发票代码</td>
								<td><input id="billCode" class="tbl_query_text"
									name="billCode" type="text"
									value="<s:property value='billCode' />" style="width: 100px" />
								</td>
								<td>发票号码</td>
								<td><input id="billNo" class="tbl_query_text" name="billNo"
									type="text" value="<s:property value='billNo' />"
						...
						<td>
							<select id="fapiaoType" name="fapiaoType" ><option value="" <s:if test='fapiaoType==""'>selected</s:if><s:else></s:else>>所有</option>
								...
								<td>认证剩余时间</td>
								<td><input id="billStartDate" class="tbl_query_text"
									name="billStartDate" type="text"
									value="<s:property value='billStartDate' />"
									style="width: 60px" /> - <input id="billEndDate"
									class="tbl_query_text" name="billEndDate" type="text"
									value="<s:property value='billEndDate' />" style="width: 60px" />
								</td>
								<td colspan="4"><input type="button"
									class="tbl_query_button"
									onMouseMove="this.className='tbl_query_button_on'"
									onMouseOut="this.className='tbl_query_button'"
									onclick="submitForm('inputInvoiceInfoListNew.action');"
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							<td align="left"><a href="#"
								onclick="submitForm('inputInvoiceInfoExcel.action');"> <img
						...
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<s:iterator value="paginationList.recordList" id="iList"
								...
								<tr align="center"
									...
									<td><s:if test="verifyDataRemain<0">已过期</s:if> <s:else>
											<s:property value='verifyDataRemain' />
										</s:else></td>
									<td><a href="javascript:void(0);"
										onClick="openViewData('inputInvoiceInfoViewDataNew.action?billNoAndCode=<s:property value='#iList.billNo'/><s:property value='#iList.billCode'/>');">
											<img
