...
<body onLoad="javascript:tips()" onmousemove="MM(event)"
	...
	<form name="Form1" method="post" action="saveBill.action" id="Form1">
		<input type="hidden" name="billInfo.billId"
			...
			type="hidden" name="fromFlag" id="fromFlag"
			value="<s:property value='fromFlag'/>" />
		...
		<table id="contenttable" class="lessGrid" cellspacing="0" width="100%"
					...
					<table cellspacing="0" border="0" cellpadding="0" width="100%"
						...
						<tr>
							<td><iframe id="subTableFrame" scrolling="auto"
									src="listBillItem1.action?billId=<s:property value='billInfo.billId'/>&isHandiwork=<s:property value='billInfo.isHandiwork'/>"
			...
			<tr class="row1">
				...
				onfocus="loadBillAmtInfo();" onkeypress="checkkey(value);" onblur="formatAmount(this,2,0,'true');"/> -->
					<input type="text" name="billInfo.sumAmt" id="billInfo.sumAmt"
			...
			<tr class="row1">
				...
				<td colspan="3"><s:if
						...
						<select name="instCode" readonly class="readonly"
							class="readOnlyText">
				...
				<td rowspan="5"><textarea name="billInfo.remark"
						id="billInfo.remark" cols="60" rows="7" readonly="readonly"><s:property
			...
			<tr class="row1">
				...
				<td colspan="3"><input type="text" name="billInfo.name"
					...
					size="100" readonly="readonly" class="readonly" /></td>
			</tr>
			<tr class="row1">
