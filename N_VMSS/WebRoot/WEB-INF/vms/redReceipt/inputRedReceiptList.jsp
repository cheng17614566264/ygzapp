...
<body onkeydow="enterkey(event)">
	<form name="Form1" method="post" action="listInputRedReceipt.action"
		id="Form1">
		<%
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							<td align="left"><a href="#" name="BtnView" id="BtnView"
								onclick="cancel(14)"> <img
									src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1033.png" />
									红冲
							</a> <a href="#" name="BtnView" id="BtnView" onclick="cancel(18)">
									<img
									src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1032.png" />
									红冲撤回
							</a> <!--					<input type="button" class="tbl_query_button" value="红冲"-->
					...
					<div id="lessGridList4" style="overflow: auto; width: 100%;">
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<tr class="lessGrid rowB">
								...
								<td align="right"><a
									href="viewSpecialReceipt.action?billId=<%=BeanUtils.getValue(bill, "billId")%>">
										<img
