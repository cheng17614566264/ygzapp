...
<body onkeydow="enterkey(event)">
				...
				<td class="centercondition">
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
							...
							class="current_status_submenu">发票作废</span> <span
							class="current_status_submenu">作废申请</span> <span
	...
	%>
								...
								<!-- 收入 -->
								<td align="right"><%=NumberUtils.format(trans.getTaxAmt().add(trans.getIncome()),"",2)%></td>
								<!-- 价税合计 -->
