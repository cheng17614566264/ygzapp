...
<script type="text/javascript">
		...
		function billSupplementPrint(){
			...
			var printCounts=document.getElementsByName("printCount");
			var message="";
			for (i = 0; i < chkBoexes.length; i++) {
				if (chkBoexes[i].checked) {
					if(printCounts[i].innerText==20){
						var j=i+1;
						message=message+j+",";
					}
				}
			...
			if (message.length>0) {
				message="第"+message.substring(0, message.length-1)+"行数据还剩一次补打次数，是否继续打印";
		...
		function billSupplementPrintDisk() {
			var faPiaoType = document
					.getElementById("billCancelInfo.fapiaoType").value;
...
<body onkeydow="enterkey(event)">
					...
					<div id="lessGridList4" style="overflow: auto; width: 100%;">
						<table class="lessGrid" cellspacing="0" rules="all" border="0"
							...
							<tr class="lessGrid head">
								...
								<th style="text-align: center">打印次数</th>
	...
	%>
								...
								<td align="center" name="printCount"><%=DataUtil.getFapiaoTypeCH(billCancel.getPrintCount()) %></td>
