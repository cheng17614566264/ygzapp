...
//				goToPage("toBackBill.action?billIds=" + ids);
      ...
      //销项管理附件查看
    	function viewImgFromInvoiceJF(){
    		var selects = document.getElementsByName("selectTransIds");
    		var count = 0 ;
    		var index = 0 ;
    		...
    		if(count>1){
    			...
    			alert("请选择记录")
    			 ...
    			 OpenModalWindowSubmit('viewImgFromBillSY.action?fileName='+val,1000,650,true);
    		}
    	}
    </script>
<style type="text/css">
					...
					<div class="widthauto1">
						<table id="tbl_query" cellpadding="0" cellspacing="0" width="100%"
							...
							<tr>
								...
								<td><s:select id="billInfo.dsource" name="billInfo.dsource"
										list="#{'SG':'手工','HX':'核心'}" headerKey='' headerValue="全部"
					...
					<table id="tbl_tools" width="100%" border="0">
						<tr>
							<td align="left"><a href="#"
								...
								<%--  <a href="#" onclick="submitForm('exportBillAsXml.action')"><img
                                src="<c:out value="${bopTheme}"/>/themes/images/icons/icon1003.png"/>导出xml格式</a> --%>
								<a href="#" onclick="viewImgFromInvoiceJF()" name="cmdR"
								id="cmdR"> <img
                            ...
                            %>
                                ...
                                %>
									<td align="center"><input
										...
										name="selectTransIds" value="<%= bill.getBillId()%>" /> <input
										name="selects"
										value="<%= bill.getInsureId()+"-"+bill.getTtmpRcno()+"-"+bill.getIsHandiwork()+"-"+bill.getBillId() %>"
										hidden /></td>
									...
									<td align="center"><%=bill.getBillDate() == null ? "" : DataUtil.getDateFormat(bill.getBillDate())%>
									</td>
									...
									<td align="center"><%=DataUtil.getDsource(bill.getDsouRce())%></td>
									<td align="center"><%=DataUtil.getDataStatusCH(
                                        bill.getDataStatus(), "BILL")%>
									</td>
									<td align="center"><a
										href="billToTrans.action?curPage=<s:property value='paginationList.currentPage'/>&billId=<%=BeanUtils.getValue(bill, "billId")%>&dsource=<%=bill.getDsouRce()%>">
											<img
