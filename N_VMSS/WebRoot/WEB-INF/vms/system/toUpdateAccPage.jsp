...
<body scroll="no" style="overflow: hidden;">
	<div class="showBoxDiv">
		<form name="formAccTitle" id="formAccTitle"
			action="updateAccTitle.action" method="post">
			<div id="editsubpanel" class="editsubpanel">
				<div style="overflow: auto; width: 100%;">
					<table id="contenttable" class="lessGrid" cellspacing="0"
						width="100%" align="center" cellpadding="0">
						<tr class="header">
							<th colspan="4">修改科目</th>
						</tr>
						<tr>
							...
							<td width="60%"><input id="accTitleCode" name="accTitleCode"
								...
								disabled="true"
								value="<s:property value='accTitle.accTitleCode' />" />&nbsp; <span
								class="spanstar">*</span> <label id="accCode"
						...
						<tr>
							...
							<td><input id="accTitleName" name="accTitleName" type="text"
								...
								onChange="funCheckTname()"
								value="<s:property value='accTitle.accTitleName' />" />&nbsp; <span
								class="spanstar">*</span> <label id="accName"
							...
							<td style="display: none"><input id='accTitleId'
								name='accTitleId'
								value='<s:property value='accTitle.accTitleId'/>' /></td>
						</tr>
