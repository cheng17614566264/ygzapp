	...
	<form id="main" action="connectCustomer.action" method="post"
						...
						<tr>
							<td><img
								...
								class="current_status_submenu"> 销项税管理 <span
									class="actionIcon">-&gt;</span>开票申请 <span class="actionIcon">-&gt;</span>关联客户(子公司)
							</span></td>
						</tr>
					</table>
				</td>
		...
		<table id="tbl_query" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td>
					...
					<s:textfield id="customerCode" name="connCust.customerCode"
		...
		<div id="lessGridList" style="overflow: auto; width: 100%;">
			<table class="lessGrid" cellspacing="0" rules="all" border="0"
				...
				<s:if
					test="paginationList.recordList != null && !paginationList.recordList.isEmpty()">
					<s:iterator value="paginationList.recordList" id="iList"
						status="stuts">
						<tr align="center"
							class="<s:if test='#stuts.index%2 == 0'>lessGrid rowA</s:if><s:else>lessGrid rowB</s:else>">
							<td><input type="checkbox"
								style="width: 13px; height: 13px;" name="customerIdList"
								value="<s:property value="#iList.subCustomerId"/>" /></td>
