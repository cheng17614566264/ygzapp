							...
							<td class="centercondition"><s:component
								...
								<div id="tbl_current_status">
									<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
										...
										class="current_status_submenu">客户回退信息</span>
								</div>
						</tr>
					</table>
		...
		<table id="tbl_tools" width="100%" border="0">
			<tr>
				<td align="left" width="400"><a href="#" name="BtnView"
					id="BtnView" onclick="submitForm('listCustomerAuditSH.action');"><img
		...
		<div id="lessGridList3" style="overflow: auto; width: 100%;">
			<table class="lessGrid" cellspacing="0" rules="all" border="0"
				...
				<tr class="lessGrid head">
					...
					<th width="15%" style="text-align: center">回退原因</th>
				...
				<s:iterator value="paginationList.recordList" id="iList"
					...
					<tr align="center"
						...
						</a> <!--  	<a title="修改" href="javascript:void(0)" onClick="OpenModalWindowSubmit('<c:out value="${webapp}"/>/editCustomer.action?customerId=<s:property value='customerID'/>',700,500,'view') ">
					<img src="<c:out value="${bopTheme}"/>/themes/images/icons/edit.png" alt="修改" style="border-width: 0px;"  />
				</a> --></td>
					</tr>
				</s:iterator>
			</table>
