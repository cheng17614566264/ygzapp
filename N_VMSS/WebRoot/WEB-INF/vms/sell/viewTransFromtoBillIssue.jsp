				...
				<td class="centercondition">
					<div id="tbl_current_status">
						<img src="<%=bopTheme%>/themes/images/icons/icon13.png" /> <span
							...
							class="current_status_submenu">红票开具</span> <span
							class="current_status_submenu">查看详情</span>
					</div> <!--			<div style="overflow:auto;width:100%;" id="list1">--> <!--			<table id="lessGridList" width="100%" class="lessGrid" cellspacing="0" rules="all" border="0" cellpadding="0" display="none" style="border-collapse: collapse;">-->
