...
//				throw new RuntimeException(I18N.getString("com.esen.util.XmlFunc.1", UtilResourceBundleFactory.class) + getNodePath(node));
			}
		}
...
//					throw new RuntimeException(I18N.getString("com.esen.util.XmlFunc.2", UtilResourceBundleFactory.class) + getNodePath(node));
				}
			}
		}
...
//			throw new RuntimeException(I18N.getString("com.esen.util.XmlFunc.3", UtilResourceBundleFactory.class));
		}
	...
	public static Element getChildNodeByAttributeInDepth(Element parent, String attName, String attValue) {
		if (StrFunc.isNull(attName) || StrFunc.isNull(attValue)) {
			throw new RuntimeException("参数不得为空");
//			throw new RuntimeException(I18N.getString("com.esen.util.XmlFunc.4", UtilResourceBundleFactory.class));
		}
