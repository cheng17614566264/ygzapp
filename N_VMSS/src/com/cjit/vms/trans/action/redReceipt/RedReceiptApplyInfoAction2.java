...
public class RedReceiptApplyInfoAction2 extends DataDealAction {
	...
	public String listRedReceiptApply() {
		...
		try {
			...
			redReceiptApplyInfo.setLstAuthInstId(lstAuthInstId);
			redReceiptApplyInfo.setdSource(request.getParameter("dSource"));
			redReceiptApplyInfo.setBillBeginDate(request.getParameter("billBeginDate")); // WJM
			redReceiptApplyInfo.setBillEndDate(request.getParameter("billEndDate"));
			redReceiptApplyInfo.setHissDteBegin(request.getParameter("hissDteBegin"));
			redReceiptApplyInfo.setHissDteEnd(request.getParameter("hissDteEnd"));
			redReceiptApplyInfo.setFapiaoType(request.getParameter("fapiaoType"));
			chanNelList = this.vmsCommonService.findCodeDictionary("CHANNEL_TYPE");
