...
public class Email {
  ...
  //ssl连接
    private static String smtpPortOfSSL = null;
    
    
    static {
    	Properties prop = new Properties();
		try {
			InputStream in = Email.class.getClassLoader().getResourceAsStream("Email.properties");
			prop.load(in);
		...
		smtpPortOfSSL = prop.getProperty("smtpPortOfSSL");
    }
     ...
     * 作者：刘俊杰
     * 功能：发送邮件
     * @param receiveMailAccount 邮件发送地址
     * @param subject 邮件主题
     * @param content  邮件内容
     * @throws MessagingException
     * @throws Exception
     */
    public static String sendEmail(String receiveMailAccount, String subject, String content) throws MessagingException {
    	...
    	try {
	        ...
	        props.setProperty("mail.smtp.port", smtpPortOfSSL);
	        props.setProperty("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
	        props.setProperty("mail.smtp.socketFactory.fallback", "false");
	        props.setProperty("mail.smtp.socketFactory.port", smtpPortOfSSL);
	        ...
	        return "邮件发送成功-"+receiveMailAccount;
    	}catch(Exception e) {
    		e.printStackTrace();
    		return "邮件发送异常-"+receiveMailAccount;
    	}finally {
    		 // 7. 关闭连接
            transport.close();
		}
    ...
    private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String subject, String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "国富人寿", "UTF-8"));
